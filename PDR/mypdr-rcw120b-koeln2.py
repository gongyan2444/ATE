...
m2 = Measurement(data=20.3,uncertainty = StdDevUncertainty([4.3]),
                 identifier="CI_609",restfreq="492.160651 GHz",unit="K km/s")
m3 = Measurement(data=58.6,uncertainty = StdDevUncertainty([17.2]),
...
m5 = Measurement(data=72.3,uncertainty = StdDevUncertainty([7.2]),
                 identifier="CO_10",restfreq="115.2712018 GHz",unit="K km/s")

m6 = Measurement(data=59.3,uncertainty = StdDevUncertainty([6.0]),
                 identifier="CO_32",restfreq="345.7959899 GHz",unit="K km/s")

m7 = Measurement(data=22.5,uncertainty = StdDevUncertainty([2.3]),
                 identifier="13CO_10",restfreq="110.2013541 GHz",unit="K km/s")

m8 = Measurement(data=14.9,uncertainty = StdDevUncertainty([1.5]),
...
fig.savefig("RCW120B-corner-koeln-non.pdf",bbox_inches='tight',pad_inches=0)
